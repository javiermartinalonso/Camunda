...
Este proyecto se centra en la construccion de delegados java en camunda BPMN.
...
[2 Camunda Tutorial for Java Developers](https://www.youtube.com/watch?v=HxtZf5VD6lQ&list=PLJG25HlmvsOUnCziyJBWzcNh7RM5quTmv&index=2 "2 Camunda Tutorial for Java Developers")
...
-    Instanciar el proceso "camundaSimpleDemo", mediante petición rest


```http
Type: Post

localhost:8080/engine-rest/process-definition/key/camundaSimpleDemo/start
