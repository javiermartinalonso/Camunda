...
Este proyecto se centra en la construccion de elementos avanzados de BPMN como son los timers, excepciones y subprocesos.
Está pensado para compilarse como war y desplegarse en un servidor de camunda. En el war se incluyen los diagramas y las clases java que implementan las tareas.

This video is view in 
[5 Camunda advanced topics](https://www.youtube.com/watch?v=gFY1UuiCVl4&list=PLJG25HlmvsOUnCziyJBWzcNh7RM5quTmv&index=5 "5 Camunda advanced topics")
...
![BPMN Process](src/main/resources/hello.png)
...
-    Instanciar la tarea de mensaje correlacionado "Usidor and Chunt have arrived" del proceso "hello", mediante petición rest
...
{
  "messageName" : "UsidorAndChunArrivedMessages",
  "businessKey" : "12"
}
```
