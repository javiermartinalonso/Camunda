...
Este proyecto se centra en desplegar un proceso BPMN como un microservicio con spring-boot.
Está pensado para compilarse como jar y desplegar como un microservicio implementado con Spring-boot. En el war se incluyen los diagramas.

This video is view in 
[Get Started With Camunda and Spring boot](https://www.youtube.com/watch?v=sHgf_EsQzfc&list=PLJG25HlmvsOUnCziyJBWzcNh7RM5quTmv&index=1 "Get Started With Camunda and Spring boot")
...
![BPMN Process](src/main/resources/win-rwc.png)
...
-    Instanciar el proceso "winWorldCup", mediante perición rest


```http
Type: Post

localhost:8080/engine-rest/process-definition/key/winWorldCup/start
...
*También podemos instanciarlo directamente desde el cockpip*
